...
const ImageGallery = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="glass rounded-xl p-8 max-w-6xl mx-auto backdrop-blur-md">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-4 gap-2 mt-6">
          ...
          <div className="flex items-center justify-center aspect-square">
            <Link
              to="/gallery"
              className="w-28 h-28 cursor-pointer rounded-full bg-accent hover:bg-accent/90 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center group"
            >
